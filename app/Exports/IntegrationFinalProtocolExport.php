...
class IntegrationFinalProtocolExport implements FromQuery ,WithHeadings 
{
    ...
    public function query()
    {
       ...
       return Integration_final ::query()->where('integration_final.DEAD_YEAR', $this->dead_year)->where('integration_final.PROTOCOL','like',$this->protocol. '%')->orderBy('PROTOCOL','ASC');
