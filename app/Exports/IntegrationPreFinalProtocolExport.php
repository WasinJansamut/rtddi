...
class IntegrationPreFinalProtocolExport implements FromQuery ,WithHeadings 
{
    use Exportable;
    ...
    public function Protocol(int $protocol)
    {
    ...
    public function query()
    {
       ...
       return Integration_prefinal ::query()->where('integration_prefinal.master_id', $this->masterfile_id)->where('integration_prefinal.PROTOCOL','like',$this->protocol. '%')->orderBy('PROTOCOL','ASC');

  //  return Integration_prefinal ::query()->orderBy('PROTOCOL','ASC');
