...
<x-app-layout>
    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <h4 class="text-gray-700 text-3xl font-medium ">
            ...
            ข้อมูล บ.กลาง ฯ ข้อมูลผู้เสียชีวิตปี
            ...
            <div class="my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                ...
                <div class="relative h-16 w-100">
                    ...
                    <div class="absolute top-0 right-0 h-16 w-100 ">
                        ...
                        <a href="{{ url('dataeclaim/exportprepare/'.$master->id) }}">
                        ...
                        <a href="{{ asset('storage/eclaim/'.$master->filename) }}" target="_blank">
                            <button
