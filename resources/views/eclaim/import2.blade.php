@section('title','แสดงผลข้อมูล บกลาง')
        ...
        <div class="flex flex-col mt-8">
            <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                <div
                    ...
                    <form action="{{ route('importeclaim3') }}" method="POST" id="import3"
                        ...
                        <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                            ...
                            <div class="md:px-32 py-8 w-full">
                                <div class="shadow overflow-hidden rounded border-b border-gray-200">
                                    ...
                                    @include('eclaim.table.table_main',
                            ...
                            <div class="table2excel">
                                ...
                                @include('eclaim.table.table1',
                                ['title' => 'ตัวแปรสำคัญ เป็นค่าว่าง CID Fname Lname <button
                                ...
                                @include('eclaim.table.table1',
                                ['title' => 'มีช่องว่างและอักขระพิเศษใน CID <button
                                    class="p-2 my-2 bg-red-500 text-white rounded-md focus:outline-none focus:ring-2 ring-red-300 ring-offset-2"
                                    type="button">Error</button>',
                                'list' => $chk_List2])
                                <hr>
                                ...
                                @include('eclaim.table.table1',
                                ['title' => 'มีช่องว่างและอักขระพิเศษใน ชื่อ หรือ นามสกุล <button
                                    class="p-2 my-2 bg-red-500 text-white rounded-md focus:outline-none focus:ring-2 ring-red-300 ring-offset-2"
                                    type="button">Error</button>',
                                'list' => $chk_List3])
                                <hr>

                                @include('eclaim.table.table2',
                                ['title' => ' ปีที่เสียชีวิต ไม่อยู่ในปีที่เลือก <button
                                    class="p-2 my-2 bg-red-500 text-white rounded-md focus:outline-none focus:ring-2 ring-red-300 ring-offset-2"
                                    type="button">Error</button>',
                                'list' => $chk_List4])
                                <hr>
                                ...
                                @include('eclaim.table.table1',
                                ['title' => ' ข้อมูลที่ซ้ำกันเองในฐาน เช็คจาก CID Fname Lname <button
                                    class="p-2 my-2 bg-red-500 text-white rounded-md focus:outline-none focus:ring-2 ring-red-300 ring-offset-2"
                                    type="button">Error</button>',
                                'list' => $chk_List5])
                                <hr>
                                ...
                                @include('eclaim.table.table2',
                                ['title' => ' วันเดือนปีที่เสียชีวิต ไม่ตรงกับความเป็นจริง <button
                                ...
                                @include('eclaim.table.table3',
                                ['title' => '07 วันเดือนปีที่เกิดไม่มี (ระบบจะนำอายุจากฐานข้อมูลดิบมาแสดงในตัวแปร
                                "อายุ") <button
                                    class="p-2 my-2 bg-yellow-500 text-white rounded-md focus:outline-none focus:ring-2 ring-yellow-300 ring-offset-2"
                                    type="button">Warning</button>',
                                'list' => $chk_List7])
                                ...
                                @include('eclaim.table.table4',
                                ['title' => '12 วันเกิดผิดปกติ (น้อยกว่าปี 1900 มากกว่าปีปัจจุบัน) <button
                                    class="p-2 my-2 bg-yellow-500 text-white rounded-md focus:outline-none focus:ring-2 ring-yellow-300 ring-offset-2"
                                    type="button">Warning</button>',
                                'list' => $chk_List13])
                                <hr>
					...
					exclude: ".noExl",
					name: "e-claim Document Name",
					filename: "e-claim data defect",
					fileext: ".xls",
					exclude_img: true,
					exclude_links: true,
					exclude_inputs: true
