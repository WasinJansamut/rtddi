@section('title','สรุปผลการนำเข้าไฟล์ บ.กลาง')
...
<x-app-layout>
    ...
    <div class="mx-auto px-6 py-8">
        <h3 class="text-gray-700 text-3xl font-medium">สรุปผลการนำเข้าข้อมูล</h3>
        ...
        <div id="hidepage" style="display:none;">
            <audio autoplay id="bgsound">
                ...
                <p>ขออภัย เว็บเบราว์เซอร์ของคุณไม่รองรับเสียงแจ้งเตือน กรุณาเปิดโปรแกรมบน Google Chrome หรือ MS Edge</p>
            </audio>
        </div>
        {{-- end loadpage --}}
                    ...
                    <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                        ...
                        <div class="p-2 text-center">
                            ...
                            <span
                                ...
                                <a href="{{url('dataeclaim')}}">
                                    << กลับสู่หน้านำเข้าไฟล์ บ.กลาง</a> </span> </div> </div> <!--/Card--> </div> </div>
