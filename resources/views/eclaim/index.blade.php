    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="flex flex-col mt-8">
            <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                ...
                <h4 class="text-gray-700 text-3xl font-medium">ประวัติการอัพโหลด ข้อมูลบ.กลาง ฯ </h4> <span
                            ...
                            <tr @if ($row_master->status=='0')
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="text-sm leading-5 text-gray-900">
                                        {{-- <a href="{{ asset('storage/eclaim/'.$row_master->filename) }}"
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm">
                                    <div class="flex item-center justify-center">
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <a href="{{url('dataeclaim',$row_master->id)}}">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110"
                                            ...
                                            <a href="{{ url('dataeclaim/cancel',$row_master->id)}}">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110"
                                            ...
                                            <a href="{{ url('dataeclaim/uncancel',$row_master->id)}}">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110"
                                            ...
                                            <a href="{{ url('dataeclaim/delete',$row_master->id)}}">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
