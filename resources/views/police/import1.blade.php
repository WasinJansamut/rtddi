@section('title','นำเข้าข้อมูลตำรวจ')
            ...
            <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                <div
                    ...
                    <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                        ...
                        <div> <a href="{{ asset('storage/template/template_police.xlsx') }}">
                ...
                <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                    ...
                    <form action="{{ route('importpolice2') }}" method="POST" id="import1" name="import1"
