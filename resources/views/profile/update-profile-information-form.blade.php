<x-jet-form-section submit="updateProfileInformation">
    ...
    <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
        ...
        <x-slot name="form">
            ...
            <!-- type -->
            <x-jet-input id="type" type="hidden" class="mt-1 block w-full" wire:model.defer="state.type" />
    ...
    <!-- status -->
    <x-jet-input id="status" type="hidden" class="mt-1 block w-full" wire:model.defer="state.status" />
    {{--  <div class="col-span-6 sm:col-span-4">
